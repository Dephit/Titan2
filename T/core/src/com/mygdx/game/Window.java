...
public class Window extends Actor{
   ...
   // private final Animation animation;
    ...
    void ordrIt(){
        if(getName().equals("refrigerator")) {
            orderRef();
        }else if(getName().equals("buyFoodMenu")) oredrBuy();
    }

    private void oredrBuy() {
        ...
        for (int i = 1; i < thisGroup.getChildren().size - 1 ; i++) {
            thisGroup.getChildren().get(i).setVisible(thisGroup.getChildren().get(i).getName().contains("nuggets") || thisGroup.getChildren().get(i).getName().contains("potato") );
            ...
            if(thisGroup.getChildren().get(i).isVisible()){
                ...
                if(thisGroup.getChildren().get(i).getName().equals("potato")){
                    textGroup.addActor(makeTextToDraw( 120+ "р", thisGroup.getChildren().get(i).getX() + thisGroup.getChildren().get(i).getWidth() * 0.67f
                ...
                if(thisGroup.getChildren().get(i).getName().equals("nuggets")){
                    textGroup.addActor(makeTextToDraw(75+ "р" + MyGdxGame.playerStats.nuggetsAmount, thisGroup.getChildren().get(i).getX() + thisGroup.getChildren().get(i).getWidth() * 0.67f
                            , thisGroup.getChildren().get(i).getY() + thisGroup.getChildren().get(i).getHeight() * 0.27f,  1, Color.BLACK));
                }
            }
            if(thisGroup.getChildren().get(i).getName().equals("closeWindow"))
    ...
    private void orderRef() {
            ...
            for (int i = 1; i < thisGroup.getChildren().size - 1 ; i++) {
                thisGroup.getChildren().get(i).setVisible(thisGroup.getChildren().get(i).getName().contains("nuggets") && MyGdxGame.playerStats.nuggetsAmount > 0
                        || thisGroup.getChildren().get(i).getName().contains("potato") && MyGdxGame.playerStats.potatoAmount > 0);
