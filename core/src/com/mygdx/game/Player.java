...
public class Player extends Npc {
    ...
    Player() {
        ...
        setName("player");
        speed = new Vector2();
        textureAtlas =  new TextureAtlas(preffics.getPath()+ "player/player.atlas");
        animMap = new TreeMap<>();

        final ArrayList<PlayerAnimationData> objectList = preffics.fromObjectFromJson("player/animation.json", ArrayList.class);
